...
<h2 style="margin-bottom:1rem;">신상품</h2>

<form action="${pageContext.request.contextPath}/product/search" method="get" style="margin-bottom:1.5rem;">
    <input type="text" name="keyword" placeholder="상품 검색..." style="padding:0.5rem; width:300px; border:1px solid #ddd; border-radius:4px;">
